                ...
                <ScrollView>
                    ...
                    <View style={[styles.commonCard, styles.regularMarginTop]}>
                        ...
                        <View style={styles.mediumMarginTop}>
                            ...
                            <View style={[styles.flexSpaceBetween, styles.regularMarginTop]}>
                                <Text style={styles.regularText}>Commission per delivery</Text>
                                <Text style={[styles.boldRegularText, styles.redTextColor]}>
                                    {currentEarningDetails.salaryBreakDown.commissionPerDelivery}
                                </Text>
                            </View>
                            ...
                            <View style={[styles.flexSpaceBetween, styles.regularMarginTop]}>
                                <Text style={styles.regularText}>Parcel Delivered</Text>
                                <Text style={[styles.boldRegularText, styles.redTextColor]}>
                                    {currentEarningDetails.salaryBreakDown.parcelsDelivered}
                                </Text>
                            </View>
                            ...
                            <View style={[styles.flexSpaceBetween, styles.regularMarginTop]}>
                                <Text style={styles.regularText}>Commission Earned</Text>
                                <Text style={[styles.boldRegularText, styles.redTextColor]}>
                                    {currentEarningDetails.salaryBreakDown.commissionPayable}
                                </Text>
                            </View>
                    ...
                    >
                        <View style={styles.tableWrapper}>
                            ...
                            {gradeSettings.gradeSlabs.length > 0 &&
                                gradeSettings.gradeSlabs.map(
                                    ({ grade, range, basic, commission }) => (
                                        <View
                                            style={[styles.row, styles.regularMarginBottom]}
                                            key={grade}
                                        >
